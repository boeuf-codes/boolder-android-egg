...
class MapViewModel(
    ...
    private fun convertCNF(P1: List<Problem>, P2: List<Problem>, P3: List<Problem>,
        ...
        converter.extractSATOutput(outputStr, true)

    }
    fun collectDataAndConvertCNF(areaName: String, wuGrades: List<String>, pGrades: List<String>, cdGrades: List<String>, distance: Float,
                                 n: Int, m: Int, p:Int) {
        viewModelScope.launch {
